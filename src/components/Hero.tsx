...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      g.to(".hero-orb", { rotate: 360, duration: 30, repeat: -1, ease: "linear" });
      ...
      if (cta) {
        const onMove = (e: PointerEvent) => {
          ...
          g.to(cta, { x: mx * 0.15, y: my * 0.15, scale: 1.03, duration: 0.2, ease: "power2.out" });
        };
        const onLeave = () => g.to(cta, { x: 0, y: 0, scale: 1, duration: 0.25, ease: "power3.out" });
      ...
      if (photo) {
        const onMoveP = (e: PointerEvent) => {
          ...
          const mx = e.clientX - rect.left - rect.width / 2;
          const my = e.clientY - rect.top - rect.height / 2;
          g.to(photo, { x: mx * 0.05, y: my * 0.05, scale: 1.02, duration: 0.3, ease: "power2.out" });
        };
        const onLeaveP = () => g.to(photo, { x: 0, y: 0, scale: 1, duration: 0.3, ease: "power3.out" });
      ...
      <div className="container hero-grid grid md:grid-cols-[1.4fr_1fr] gap-7 items-center">
        <div className="hero-content">
          <h1 className="hero-title">
            ...
            <span className="hero-line">
              <span className="accent">fast</span>, <span className="accent">smooth</span>, and
